 ...
 * Created by xiyuanbupt on 9/1/16.
 ...
 You may assume that it is a perfect binary main.java.bupt.wxy.tree (ie, all leaves are at the same level, and every parent has two children).
 For example,
 Given the following perfect binary main.java.bupt.wxy.tree,
 1
 /  \
 2    3
 / \  / \
 4  5  6  7
 After calling your function, the main.java.bupt.wxy.tree should look like:
 1 -> NULL
 /  \
 2 -> 3 -> NULL
 / \  / \
